...
import { Container, Title } from './Geo.styles'
  ...
  return (
    <Container>
      ...
      <div style={{textAlign: 'left', margin: '0 auto', width: '360px'}}>
        <span><strong>Javascript Only:</strong> navigator.geolocation & userAgent</span><br/><br/>
        ...
        <button type="button" onClick={getCurrentPosition}>getCurrentPosition</button><br/>
        ...
        <span><strong>altitude :</strong> {userGeolocation.coords.altitude ? userGeolocation.coords.altitude : "not available for this device"}</span><br/>
      ...
      <div style={{width: '360px', height: '1px', backgroundColor: 'black', margin: '0 auto'}} /><br/>
